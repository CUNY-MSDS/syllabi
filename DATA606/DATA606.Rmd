...
course_schedule <- readxl::read_excel('DATA606.xlsx')
schedule <- readxl::read_excel(paste0('../Schedules/', params$year, '-', params$semester, '.xlsx'))
...
knitr::kable(course_schedule[,c('Topic', 'Dates')], row.names = FALSE)
```
